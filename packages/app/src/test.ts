...
import {
  dcterms,
  // xsd,
  // namespaceFactory as createNamespace,
} from "@ldkit/namespaces";
...
export const main = () => {
  ...
  createDefaultContext({
    type: "sparql",
    value: "https://graphdb.onto.fel.cvut.cz/repositories/kodi-uloziste-dev",
  });
...
workspaces.find().subscribe((data) => {
  console.log("DATA");
